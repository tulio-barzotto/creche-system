package br.com.crechesystem.crechesystem.configuration;

import br.com.crechesystem.crechesystem.security.TokenAuthenticationFilter;
import br.com.crechesystem.crechesystem.security.TokenAuthenticationProcessingFilter;
import br.com.crechesystem.crechesystem.security.TokenAuthenticationService;
import br.com.crechesystem.crechesystem.security.TokenHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/js/**", "/styles/**", "/lib/**", "/template/**", "/images/**", "/favicon.ico").permitAll()
